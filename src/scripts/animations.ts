...
JOS.init({
  ...
  duration: 1, // Set global the duration for the animation playback | Values :  flota : 0-1 & int : 0,1,2,3,4,5
  ...
  // intersectionRatio: 1, // Set the intersection ratio between which the element should be visible | Values :  0-1 (automaticaly set)
